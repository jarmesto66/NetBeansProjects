...
public class UD5_CP1_AgendaV2 {
    ...
    public static void main(String[] args) {
        ...
        // Vectores con la información de los contactos
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    printContactosVector(vn, vt, vc, vpos);
                    break;
    ...
    // Imprime la información solo del contacto 'pos' (índice de los vectores) 
    public static void printContactoPos(String[] vn, String[] vt, String[] vc, int pos) {
        System.out.println(pos + ". " + vn[pos] + " - " + vt[pos] + " - " + vc[pos]);
    }

    // Imprime la información de todos los contactos
    public static void printContactosTodos(String[] vn, String[] vt, String[] vc) {
        for (int i = 0; i < numC; i++) {
            printContactoPos(vn, vt, vc, i);
        }
    }

    // Imprime la información de los contactos indicados en 'vpos' (vector de posiciones)
    public static void printContactosVector(String[] vn, String[] vt, String[] vc, int[] vpos) {
        for (int i = 0; i < vpos.length; i++) {
            printContactoPos(vn, vt, vc, vpos[i]);
        }
    }
