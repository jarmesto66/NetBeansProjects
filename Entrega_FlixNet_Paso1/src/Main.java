...
public class Main extends javax.swing.JFrame {
    ...
    private void cargarContenidoInicial() {
        ...
        Contenido serie1 = new Serie(15, visto, "Big Bang Theory", "Tractor amarillo", 1982);
        flixnet.add(serie1);
        Contenido serie2 = new Serie(1, visto, "Armaggedon", "Netflix", 2023);
        flixnet.add(serie2);
        Contenido serie3 = new Serie(15, visto, "Curro Jiménez", "Chicho Ibañez", 1980);
        flixnet.add(serie3);
